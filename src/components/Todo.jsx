...
const Todo = (props) => {
  return (
    <div className="flex justify-between bg-blue-500 px-6 py-3 items-center rounded-md">
      <h2 className="text-white font-bold text-lg">{props.text}</h2>
      <div className="button flex gap-4">
        {/* <button className="text-white font-bold rounded-md px-3 py-1 text-lg">
          Edit
        </button> */}
        <svg
